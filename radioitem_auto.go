package glui
func (e *radioItem) On(name string, fn EventListener) *radioItem {
...
func (e *radioItem) CalcDepth(stack *ElementStack) {
...
func (e *radioItem) appendChild(children ...Element) Element {
